...
/**
 * This class was generated by Apache CXF 3.1.1 2015-07-09T17:38:11.840+02:00
 * Generated source version: 3.1.1
 * 
 */
@WebServiceClient(name = "PlaybackControl_v1_0", wsdlLocation = "/datafs/config/dolby-smi/PlaybackControl.wsdl", targetNamespace = "http://www.dolby.com/dcinema/ws/smi/v1")
public class PlaybackControlV10 extends Service {
	...
	static {
		...
		if (url == null) {
			url = PlaybackControlV10.class.getClassLoader().getResource(
			        "/dolby-smi/PlaybackControl.wsdl");
		}
		if (url == null) {
			java.util.logging.Logger.getLogger(PlaybackControlV10.class.getName()).log(
	...
	/**
	 *
	 * @return returns PlaybackControlServiceV10
	 */
