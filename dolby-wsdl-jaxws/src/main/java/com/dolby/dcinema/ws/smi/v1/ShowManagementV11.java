 ...
 * 
 */
@WebServiceClient(name = "ShowManagement_v1_1", wsdlLocation = "/datafs/config/dolby-smi/ShowManagement.wsdl", targetNamespace = "http://www.dolby.com/dcinema/ws/smi/v1")
