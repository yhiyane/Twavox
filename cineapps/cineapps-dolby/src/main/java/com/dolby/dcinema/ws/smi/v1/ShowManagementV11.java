 ...
 * 2015-07-09T17:41:04.110+02:00
 * Generated source version: 3.1.1
 * 
 */
@WebServiceClient(name = "ShowManagement_v1_1", 
...
public class ShowManagementV11 extends Service {
    ...
    public final static QName SERVICE = new QName("http://www.dolby.com/dcinema/ws/smi/v1", "ShowManagement_v1_1");
    ...
    static {
        ...
        if (url == null) {
            url = ShowManagementV11.class.getClassLoader().getResource("/dolby-smi/ShowManagement.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(ShowManagementV11.class.getName())
     ...
     *
     * @return
     *     returns ShowManagementServiceV11
     */
