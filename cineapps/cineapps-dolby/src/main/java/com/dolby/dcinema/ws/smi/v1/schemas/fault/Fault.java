...
@XmlSeeAlso({
    ...
    NotReady.class,
    NotFound.class,
    ContentFailure.class,
    ContentStoreFailure.class,
    DeviceComponentFailure.class,
    InvalidArgumentFailure.class,
    InvalidAuditorium.class,
    InvalidTransportStateFailure.class,
    BusyFailure.class,
    OperationNotImplemented.class,
